...
typedef struct {
  freedomk64f_DigitalWrite_VOO_T obj;  /* '<Root>/Digital Write7' */
  freedomk64f_DigitalWrite_VOO_T obj_n;/* '<Root>/Digital Write6' */
  freedomk64f_DigitalWrite_VOO_T obj_i;/* '<Root>/Digital Write5' */
  freedomk64f_DigitalWrite_VOO_T obj_ib;/* '<Root>/Digital Write4' */
  ...
  freedomk64f_DigitalWrite_VOO_T obj_h;/* '<Root>/Digital Write' */
...
struct P_VOO_T_ {
  real_T PWM_Value;                    /* Expression: 350
  ...
  real_T BPM_Value;                    /* Expression: 60
                                        ...
                                        */
  real_T Pulse_Width_Value;            /* Expression: 400
